...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println("-- Datos de persona con DNI 33333333: /n" + persona.traerPersona(33333333));
		
		System.out.println("-- Datos de vacunas fabricadas entre 1 y 2 meses: ");
		System.out.println(vacuna.traerVacuna(1, 2));
		
		System.out.println("-- Dosis aplicadas a persona con DNI 33333333: ");
		System.out.println(dosis.traerDosis(persona.traerPersona(33333333)));
		
		System.out.println("-- Dosis aplicadas entre 2020-06-01 y 2020-06-15: ");
		System.out.println(dosis.traerDosis(LocalDate.of(2020, 06, 01), LocalDate.of(2020, 06, 05)));
		
		System.out.println("-- Dosis aplicadas entre 2020-05-01 y 2020-05-15 a personas con comorbilidades: ");
		System.out.println(dosis.traerDosis(LocalDate.of(2020, 05, 01), LocalDate.of(2020, 05, 05), true));
	}
