...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println("-- Listado de todos los dispositivos: \n" + d.traer());
		
		System.out.println("-- Agrego Eventos a la BD y despues los muestro: ");
		try {
		...
		System.out.println("-- Eventos entre las fechas 2023-04-03 12:00 y 2023-04-05 12:00: ");
		...
		System.out.println("-- Eventos entre las fechas 2023-04-03 12:00 y 2023-04-05 12:00 del dispositivo 'cortina pieza': ");
		System.out.println(e.traer(fechaHoraDesde, fechaHoraHasta, d.traer("cortina pieza")));
		
		System.out.println("-- Dispositivos de tipo 'SensorTemperatura': ");
